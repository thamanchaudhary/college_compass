...
<div class="container">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div class="row">
            ...
            <a href="{{route( 'admin.address.index')}}" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm"><i class="fa fa-search fa-sm text-white-50"></i> Address List</a>&nbsp;
